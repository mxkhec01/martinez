...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.operador.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.operadors.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="form-row">
                ...
                <div class="form-group col-md-1">
                    ...
                    <input class="form-control date {{ $errors->has('fecha_nacimiento') ? 'is-invalid' : '' }}" type="text" name="fecha_nacimiento" id="fecha_nacimiento" value="{{ old('fecha_nacimiento') }}">
                ...
                <div class="form-group col-md-1">
                    ...
                    <input class="form-control date {{ $errors->has('fecha_ingreso') ? 'is-invalid' : '' }}" type="text" name="fecha_ingreso" id="fecha_ingreso" value="{{ old('fecha_ingreso') }}">
                ...
                <div class="form-group col-md-3">
                    ...
                    <input class="form-control {{ $errors->has('licencia') ? 'is-invalid' : '' }}" type="text" name="licencia" id="licencia" value="{{ old('licencia', '') }}">
                ...
                <div class="form-group col-md-1">
                    ...
                    <input class="form-control {{ $errors->has('tipo_licencia') ? 'is-invalid' : '' }}" type="text" name="tipo_licencia" id="tipo_licencia" value="{{ old('tipo_licencia', '') }}">
                ...
                <div class="form-group col-md-1">
                    ...
                    <input class="form-control date {{ $errors->has('vence') ? 'is-invalid' : '' }}" type="text" name="vence" id="vence" value="{{ old('vence') }}">
                    @if($errors->has('vence'))
                        <div class="invalid-feedback">
                            {{ $errors->first('vence') }}
                        </div>
            ...
            <div class="form-row">
                <div class="form-group col-md-4">
                    ...
                    <input class="form-control {{ $errors->has('imss') ? 'is-invalid' : '' }}" type="text" name="imss" id="imss" value="{{ old('imss', '') }}">
                    @if($errors->has('imss'))
                        <div class="invalid-feedback">
                            {{ $errors->first('imss') }}
                        </div>
            ...
            <div class="form-row">
                <div class="form-group col-md-3">
                    ...
                    <input class="form-control {{ $errors->has('tarjeta_bancaria') ? 'is-invalid' : '' }}" type="text" name="tarjeta_bancaria" id="tarjeta_bancaria" value="{{ old('tarjeta_bancaria', '') }}">
