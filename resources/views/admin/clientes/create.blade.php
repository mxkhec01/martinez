            ...
            <form method="POST" action="{{ route('admin.clientes.store') }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label class="required"
                        for="razon_social">{{ trans('cruds.cliente.fields.razon_social') }}</label>
                ...
                <div class="form-row">
                    <div class="form-group col-md-8">
                        ...
                        <input class="form-control {{ $errors->has('calle') ? 'is-invalid' : '' }}" type="text"
                            name="calle" id="calle" value="{{ old('calle', '') }}">
                        @if ($errors->has('calle'))
                            <div class="invalid-feedback">
                                {{ $errors->first('calle') }}
                            </div>
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input class="form-control {{ $errors->has('numero_exterior') ? 'is-invalid' : '' }}" type="text"
                            name="numero_exterior" id="numero_exterior" value="{{ old('numero_exterior', '') }}">
                ...
                <div class="form-row">
                    <div class="form-group  col-md-8">
                        ...
                        <input class="form-control {{ $errors->has('colonia') ? 'is-invalid' : '' }}" type="text"
                            name="colonia" id="colonia" value="{{ old('colonia', '') }}">
                    ...
                    <div class="form-group  col-md-4">
                        ...
                        <input class="form-control {{ $errors->has('codigo_postal') ? 'is-invalid' : '' }}" type="text"
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input class="form-control {{ $errors->has('ciudad') ? 'is-invalid' : '' }}" type="text"
                            name="ciudad" id="ciudad" value="{{ old('ciudad', '') }}">
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <input class="form-control {{ $errors->has('latitud') ? 'is-invalid' : '' }}" type="text"
                            name="latitud" id="latitud" value="{{ old('latitud', '') }}">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input class="form-control {{ $errors->has('longitud') ? 'is-invalid' : '' }}" type="text"
                            name="longitud" id="longitud" value="{{ old('longitud', '') }}">
